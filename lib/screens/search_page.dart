...
class _SearchPageState extends State<SearchPage>
  ...
  List<Product> products = [
    Product(
      'assets/storage_racks.png',
      'Metal Storage Racks',
      'Heavy-duty metal storage racks for warehouse storage needs.',
      199.99,
    ),
    Product(
      'assets/forklift.png',
      'Forklift Machine XL',
      'Powerful forklift machine for efficient warehouse operations.',
      9999.99,
    ),
    Product(
      'assets/shipping_boxes.png',
      'Shipping Boxes (Pack of 50)',
      'Pack of 50 sturdy shipping boxes for packaging and shipping goods.',
      45.99,
    ),
  ];
