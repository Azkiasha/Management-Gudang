...
class _ShopBottomSheetState extends State<ShopBottomSheet> {
  List<Product> products = [
    Product('assets/sepatu_1.png', 'Sepatu Pantofel', 'description', 45.3),
    Product('assets/sepatu_2.png', 'Sepatu Sneakers', 'description', 22.3),
    Product('assets/sepatu_3.png', 'Sepatu Lari', 'description', 58.3)
  ];
